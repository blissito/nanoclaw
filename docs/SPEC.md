...
export const CONTAINER_STALL_TIMEOUT = parseInt(process.env.CONTAINER_STALL_TIMEOUT || '3600000', 10); // 60min without progress
export const CONTAINER_MAX_LIFETIME = parseInt(process.env.CONTAINER_MAX_LIFETIME || '259200000', 10); // 3 days, 0 = unlimited
export const IPC_POLL_INTERVAL = 1000;
export const IDLE_TIMEOUT = parseInt(process.env.IDLE_TIMEOUT || '1800000', 10); // 30min — keep container alive after last result
export const MAX_CONCURRENT_CONTAINERS = Math.max(1, parseInt(process.env.MAX_CONCURRENT_CONTAINERS || '8', 10) || 8);
